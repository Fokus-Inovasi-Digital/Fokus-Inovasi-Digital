<x-landing-layout>
    <section id="cta" class="py-14 pt-40 md:py-32">
        <div class="container mx-auto px-4">
            <div class="glass rounded-3xl p-8 md:p-16 text-center max-w-5xl mx-auto shadow-2xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center animate-blur-in">
                    <a href="#contact" class="btn-primary text-lg px-8 py-3">
                        <span class="relative z-10">Contact Our Experts Now</span>
                    </a>
                    <a href="/services"
